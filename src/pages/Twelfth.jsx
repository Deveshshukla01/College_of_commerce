      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10">
            ...
            regular testing, and structured revision.
          </p>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 mb-10">
            Academic Year{" "}
            <span className="font-semibold text-red-600">2026–27</span>
          </p>
            ...
            {[
              {
                ...
                fee: "₹30,000",
                plan: [
                  "₹5,000 payable at registration",
                  "5 monthly installments of ₹5,000",
                ],
              },
              {
                subject: "Accountancy",
              ...
              },
              {
                ...
                fee: "₹40,000",
                plan: [
                  "₹10,000 payable at registration",
                  "6 monthly installments of ₹5,000",
                ],
              },
            ].map((item) => (
              <div
            ...
            {[
              {
                ...
                desc:
                  "If a student is unable to attend classes due to emergency reasons, extra time and academic support are provided so the student remains in tune with the regular batch.",
              },
              {
                title: "Complete Course Coverage",
                desc:
                  "The entire syllabus is covered within the specified duration through a structured and disciplined teaching methodology.",
              },
              {
