...
// //               <p>
// //                 <span className="font-semibold text-red-600">Step 1:</span>{" "}
// //                 Scan the QR code displayed below and pay the required admission
// //                 amount. After successful payment, you will receive a{" "}
// //                 <span className="font-semibold">Transaction ID</span>.
// //               </p>

// //               <p>
// //                 <span className="font-semibold text-red-600">Step 2:</span>{" "}
// //                 Fill in the admission form carefully with all the required
// //                 personal, academic, and contact details.
// //               </p>

// //               <p>
// //                 <span className="font-semibold text-red-600">Step 3:</span>{" "}
// //                 At the bottom of the form, enter the{" "}
// //                 <span className="font-semibold">Transaction ID</span> that you
// //                 received after making the payment. Please ensure the Transaction
// //                 ID is entered correctly.
// //               </p>

// //               <p>
// //                 After successful verification of your payment,{" "}
// //                 <span className="font-semibold">
// //                   The College of Commerce
// //                 </span>{" "}
// //                 will contact you for further admission procedures.
// //               </p>
// //             </div>
// //           </div>
...
// //           {/* QR CODE */}
// //           <div className="border border-dashed rounded-xl p-4 text-center mb-8">
// //             <p className="text-sm text-gray-500 mb-2">Scan QR Code to Pay</p>
// //             <div className="h-40 flex items-center justify-center bg-gray-100 rounded-md text-gray-400">
// //               QR Code Here
// //             </div>
// //           </div>

// //           <form onSubmit={handleSubmit} className="space-y-8">
// //             <input type="text" name="class" required placeholder="Class" className="input" />
...
// //               <p className="font-semibold text-red-600">Personal Details</p>
...
// //             <div className="space-y-4">
// //               <p className="font-semibold text-red-600">Qualification Details</p>
...
// //             <div>
// //               <p className="font-semibold text-red-600 mb-2">Payment Details</p>
// //               <input name="transaction_id" required placeholder="Transaction ID" className="input" />
// //             </div>
...
// //               disabled={loading}
// //               type="submit"
// //               className="w-full bg-red-600 text-white py-3 rounded-md font-semibold hover:bg-red-700 disabled:opacity-60"
// //             >
...
//               <p className="font-medium text-center text-gray-800 pt-2">
...
//             <p className="text-sm text-gray-500 mb-2">Scan QR Code to Pay</p>
//             <div className="h-44 flex items-center justify-center rounded-lg bg-white shadow-inner text-gray-400">
//               QR Code Here
//             </div>
//           </div>
...
//               disabled={loading}
//               type="submit"
//               className="w-full bg-red-600 hover:bg-red-700 text-white py-4 rounded-xl font-semibold transition disabled:opacity-60"
//             >
//               {loading ? "Submitting..." : "Submit Application"}
//             </button>
//           </form>
