        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl p-8 md:p-12">
          ...
          <div className="space-y-5 text-sm text-gray-700">
            ...
            <div>
              ...
              <p>
                Pay the required admission amount {" "}
                <strong className="text-gray-900"></strong> and then fill in the
                admission form.
              </p>
              <p className="mt-1">
                <strong className="text-gray-900">
          ...
          <div className="text-center mb-10">
            ...
            <img
              ...
              alt="Payment QR Code"
              className="mx-auto h-64 w-44 object-contain rounded-xl shadow-md bg-white p-2"
            />
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            {/* UPDATED SECTION */}
            <Section title="Subject You Wish To Join">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
                {[
                  ...
                  <label key={subject} className="flex items-center gap-2">
                    <input type="checkbox" name="course" value={subject} />
                    {subject}
                  </label>
                ))}
              </div>
            ...
            <Section title="Personal Details">
              ...
              <input name="dob" type="date" required placeholder="DOB" className="input" />
              <input name="guardian_name" required placeholder="Parents / Guardian Name" className="input" />
              <input name="profession" placeholder="Parents Profession & Designation" className="input" />
              ...
              <textarea name="correspondence_address" required placeholder="Email Id" className="input" />
            </Section>

            <Section title="Contact Details">
              <div className="grid md:grid-cols-3 gap-4">
                <input name="father_contact" required placeholder="Father's Contact No." className="input" />
                <input name="mother_contact" placeholder="Mother's Contact No." className="input" />
                <input name="student_contact" required placeholder="Student's Contact No." className="input" />
              </div>
            </Section>
            ...
            <div className="mt-4 flex flex-col sm:flex-row justify-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-5 py-2 rounded-full border border-green-500 text-green-600 text-sm font-medium hover:bg-green-50 transition"
              >
                WhatsApp Support
              </a>
            </div>
