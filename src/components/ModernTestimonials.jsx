...
const testimonials = [
  ...
  },
  {
    ...
    image: "/images/testimonials/2.png",
    text:
      "College Of Commerce is an excellent coaching centre! The teachers are very knowledgeable and help us understand the subjects well. Regular tests keep us prepared for competitive exams.",
  },
  {
    id: 3,
    name: "Suraj Maurya",
    ...
    image: "/images/testimonials/3.png",
    text:
      "The College of Commerce stands out as an exceptional coaching center, offering high-quality courses that truly prepare students for success.",
  },
  {
    id: 4,
    name: "Manu Padam",
    ...
    image: "/images/testimonials/4.png",
    text:
      "College Of Commerce is an exceptional coaching centre that truly prioritizes its students. Regular evaluations keep us on track.",
  },
  {
    id: 5,
    name: "Sachit Ghambir",
    ...
    image: "/images/testimonials/5.png",
    text:
      "College of Commerce is the best institution in North India with highly knowledgeable and dedicated faculty.",
  },
  {
    id: 6,
    name: "Riya Singh",
    ...
    image: "/images/testimonials/6.png",
    text:
      "College of Commerce offers top-notch B.Com coaching with experienced faculty and comprehensive study resources.",
  },

  // ✅ NEW TESTIMONIALS (Letter Avatar)
  {
    id: 7,
    name: "Navjot Kaur",
    ...
    image: null,
    text:
      "When it comes to accounts coaching, College of Commerce is simply the best. Their detailed explanations, regular tests, and doubt-solving sessions turn complex topics into child's play.",
  },
  {
    id: 8,
    name: "Reena Khan",
    ...
    image: null,
    text:
      "College of Commerce is the best place for CA coaching. Their expert faculty, updated study material, and personal guidance make the toughest concepts easy to grasp.",
  },
  {
    id: 9,
    name: "Arvind Dutt",
    ...
    image: null,
    text:
      "Highly experienced faculty and regular evaluation of students with feedback to parents. Very impressive teaching methodology with full energy and motivation.",
  },
];
...
export default function TestimonialGrid() {
  ...
  const prev = () =>
    setActiveIndex((i) => (i === 0 ? testimonials.length - 3 : i - 1));

  const next = () =>
    setActiveIndex((i) =>
      i >= testimonials.length - 3 ? 0 : i + 1
    );
        ...
        <div className="mt-16 text-center">
          <div className="flex justify-center items-center gap-1">
            ...
            <span className="text-sm">
              Rated <strong>4.8</strong> • 547 reviews
            </span>
          </div>
...
function TestimonialCard({ item }) {
  return (
    <div className="relative bg-white border border-slate-200 rounded-xl p-8 text-center shadow-md flex flex-col justify-between min-h-[420px] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_-10px_rgba(220,38,38,0.45)]">
      ...
      <div>
        ...
        {item.image ? (
          <img
            src={item.image}
            alt={item.name}
            className="w-16 h-16 rounded-full mx-auto mt-6 mb-4 border-2 border-red-600 object-cover"
          />
        ) : (
          <div className="w-16 h-16 rounded-full mx-auto mt-6 mb-4 bg-red-600 text-white flex items-center justify-center text-xl font-bold border-2 border-red-600">
            {item.name.charAt(0)}
          </div>
        )}
