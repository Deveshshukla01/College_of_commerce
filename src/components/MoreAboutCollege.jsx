...
//         <p className="text-lg font-medium text-gray-700">More about</p>
...
//                   ${isActive ? "scale-110 z-10" : "scale-95 opacity-90"}
//                 `}
//               >
//                 <video
...
//           <button
//             onClick={() => move("prev")}
//             className="absolute -left-6 bg-white border border-black p-3 rounded-full"
//           >
...
//           <button
//             onClick={() => move("next")}
//             className="absolute -right-6 bg-white border border-black p-3 rounded-full"
//           >
...
//           <div
//             onClick={() => playVideo(active ?? 0)}
//             className="relative rounded-xl overflow-hidden"
//           >
//             <video
//               ref={(el) => (videoRefs.current[active ?? 0] = el)}
//               src={ITEMS[active ?? 0].video}
//               controls
//               preload="metadata"
//               className="w-[280px] h-[360px] object-contain bg-black"
//             />
...
//           <button
//             onClick={() => move("prev")}
//             className="absolute left-0 bg-white border border-black p-3 rounded-full"
//           >
//             <ChevronLeft className="text-red-600" />
//           </button>
...
//           <button
//             onClick={() => move("next")}
//             className="absolute right-0 bg-white border border-black p-3 rounded-full"
//           >
//             <ChevronRight className="text-red-600" />
//           </button>
//         </div>
